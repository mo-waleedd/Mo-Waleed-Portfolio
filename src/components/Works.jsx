      ...
      >
        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 justify-end m-3 card-img_hover">
            ...
            className="black-grdient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer">
    ...
    <motion.div variants={textVariant()}>
      ...
      <div className="w-full flex">
        ...
        className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          Following projects showcases my skills and my experience through
